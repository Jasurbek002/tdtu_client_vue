export const finace = [
  ...
  "Beruniy nomidagi davlat stipendiyasi",
  "Islom Karimov nomidagi davlat stipendiyasi",
  "Universitet rektori stipendiyasi",
  "Abdulla Qodiriy nomidagi davlat stipendiyasi",
  "Atoqli olimlar nomidagi universitet stipendiyasi",
  "GTL UZBEKISTON stipendiyasi",
...
export const courses_text = `TITning asosiy maqsadi talabalarning ilmiy-tadqiqot ishlarini rivojlantirishga
 yordam berish, nazariy va amaliy bilim darajasini oshirish, talabalar ilmiy to‘garagi doirasida innovatsion 
 jarayonlarda ishtirok etish va boshqarish ko‘nikmalarini rivojlantirish, amaliy muammolarni hal qilishda loyiha
  faoliyatida ko‘nikmalarni shakllantirish, tadqiqot kompetensiyalarini shakllantirish uchun qulay shart-sharoitlarni
   yaratish va rivojlantirish, har bir o‘quvchiga o‘z qobiliyati va ehtiyojlariga mos ravishda o‘z shaxsiyatini ijodiy 
   rivojlantirish huquqini amalga oshirish imkoniyatini ta’minlash, ilmiy-pedagogik kadrlar zaxirasini shakllantirish uchun
    istiqbolli va iqtidorli yoshlarni tanlashdan iborat. 2.2. TITning asosiy vazifalari quyidagilardan iborat: - talabalarning 
    ilmiy tayyorgarlik darajasini oshirishga yordam berish; - talabalarnin ijodiy faoliyatni shakllantirish uchun sharoit yaratish; - talabalarning 
    kasbiy tayyorgarligi sifatini oshirish; - talabalarga mustaqil ilmiy izlanishlar olib borishlariga amaliy yordam berish va ularning ilmiy ishlarini 
    tashkiliy ta’minlash; - iqtidorli va qobiliyatli talabalarni aniqlash, ta’lim jarayoni samaradorligini oshirishning dolzarb masalalarini hal etishda 
    ularning ijodiy va intelektual salohiyatlaridan foydalanish; - talabalarni Davlat ilmiy-texnik dasturlari doirasida amalga oshiriladigan loyihalar va 
