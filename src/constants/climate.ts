...
TSTU is making progress in reducing its carbon emissions. The university is committed to continuing these efforts and to becoming a more sustainable institution.
  ...
  {
    id: 17,
    title: `TSTU's Anti-Bribery and Corruption Policy.`,
    text: `
  ...
  {
    id: 19,
    title: `Advancing Sustainable Development at TSTU: The Role of the Director of Sustainability`,
    text: `
  ...
  {
    id: 22,
    title: `Cultivating Ethical Culture: The Role of the Office for Ethical Compliance at TSTU`,
    text: `
...
`,
  ...
  {
    id: 23,
    title: `Ensuring Accountability and Employee Support: TSTU's Internal Reporting System and Grievance Procedure
    `,
    text: `
  ...
  {
    id: 24,
    title: `Empowering Student Representation: TSTU's Recognized Student Union`,
    text: `
