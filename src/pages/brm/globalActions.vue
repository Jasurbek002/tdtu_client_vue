...
<template>
	<Row label="Green Actions" styles="bg-white">
		<div
			...
			:key="i"
			class="w-[420px] min-h-[500px] bg-green-500 shadow-amber-200 pb-3 rounded-lg border border-[#4793AF] shadow my-5 flex justify-between items-center flex-col hover:border-[#007F73]"
		>
